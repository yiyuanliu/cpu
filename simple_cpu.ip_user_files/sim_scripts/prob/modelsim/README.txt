...
#
# Generated by export_simulation on Sun Oct 07 21:19:54 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './prob.sh' script.
...
./prob.sh -noclean_files

For more information on the script, please type './prob.sh -help'.
